...
MESA_INSTALL_PREFIX=${MESA_INSTALL_PREFIX:-/usr}
...
export __EGL_VENDOR_LIBRARY_FILENAMES="${__EGL_VENDOR_LIBRARY_FILENAMES:-${MESA_INSTALL_PREFIX}/share/glvnd/egl_vendor.d/50_mesa.json}"
export VK_DRIVER_FILES="${VK_DRIVER_FILES:-${MESA_INSTALL_PREFIX}/share/mesa-gororoba/vulkan/icd.d/r3v_icd.x86_64.json}"
