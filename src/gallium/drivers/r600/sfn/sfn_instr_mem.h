...
private:
   ...
   static bool emit_uav_store_r600(nir_intrinsic_instr *intr, Shader& shader);
   static bool emit_uav_returning_instr_r600(nir_intrinsic_instr *intr, Shader& shader);
