				  ...
				  void *addr_callback_data)
{
	...
	case PKT3_EVENT_WRITE:
		/* VGT_EVENT_INITIATOR is used for the EVENT_TYPE field.  To decode it
		 * symbolically via eg_dump_reg, the register dump table would need an
		 * entry for R_028A90 -- left as raw hex for now.
		 */
