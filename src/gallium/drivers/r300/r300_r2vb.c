...
r2vb_create_selftest_bo(struct r300_context *r300, uint32_t width_bytes,
                        uint32_t fill_val)
{
    ...
    if (fill_val != 0) {
        ...
        void *map = r300->context.buffer_map(&r300->context, res, 0,
...
static void
r2vb_report_stage3_readback(struct r300_context *r300,
                             struct pipe_resource *stage3,
                             uint32_t s3dim)
{
...
static void
r2vb_report_bo_a_diagnostic(struct r300_context *r300,
