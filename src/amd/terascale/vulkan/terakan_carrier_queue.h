 ...
 * caller leaves these helpers unused; the queue-submit path is
 * unchanged.
 */
 ...
 * post-release EOP fence write is 6 dwords (PKT3_EVENT_WRITE_EOP
 * header plus 5 body dwords).
 ...
 * non-radeon winsys paths leave this helper unused because they have
 * no carrier import path either.
 *
