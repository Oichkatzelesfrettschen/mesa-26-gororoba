 ...
 * r300vk_synthesize_mat4vec_fs (r300vk_pipeline.c), not built here: the broadcast
...
nir_shader *r300vk_build_qnormalize_fs_nir(const nir_shader_compiler_options *opts);
