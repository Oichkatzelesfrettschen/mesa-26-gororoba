...
main(int argc, char **argv)
{
   ...
   if (legacy_query != NULL && properties2_query != NULL) {
      ...
      /* R8_UNORM's UNORM8 gather decodes, and the grant waits on a
       * pipeline that admits the draw: advertising it ahead of that
       * gate turns a withheld feature into a blocking failure at
