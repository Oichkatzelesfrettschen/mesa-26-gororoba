...
REQUIRED_TESTS: tuple[str, ...] = (
    ...
    *R3V_FLOAT2_TUPLE_REQUIRED_TESTS,
    ...
    "r3v-native-submit-order-robust-oob-w0-degenerate",
    "r3v-native-submit-order-robust-oob-disabled",
    "r3v-native-submit-order-gpu-fetched-composed",
    "r3v-native-submit-order-gpu-fetched-composed-f32_3",
    "r3v-native-submit-order-gpu-fetched-composed-f32_2",
    ...
    "r3v-native-submit-order-indexed-zero-record-degenerate",
    ...
    "r3v-native-submit-order-sample-mask-zero-armed",
    "r3v-native-submit-order-write-mask-zero-armed",
    ...
    "r3v-native-submit-order-vertex-index-armed",
    "r3v-native-submit-order-instanced-robust-armed",
    ...
    "r3v-native-fetched-gpu-producer-record-f32_2",
