...
r3v_native_compute_cell_kind(enum r300_gpu_route_contract_id contract_id)
{
   ...
   /* Both RB2D linear fill contracts write a transfer destination through
    * the fill route, so neither names a compute cell kind and the
    * admission below declines them. */
