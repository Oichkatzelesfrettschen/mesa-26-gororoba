...
enum r300_operation_id {
   ...
   R300_OPERATION_ID_BITWISE_NOT_MAP = 55,
   R300_OPERATION_ID_COUNT = 56,
};
...
enum r300_operation_implementation_id {
   ...
   R300_OPERATION_IMPLEMENTATION_RB2D_LINEAR_SOLID_FILL = 2,
   R300_OPERATION_IMPLEMENTATION_COUNT = 3,
};

enum r300_gpu_route_contract_id {
   R300_GPU_ROUTE_CONTRACT_NONE = 0,
   R300_GPU_ROUTE_CONTRACT_R2VB_COMPUTE_IDENTITY_CARRIER = 1,
   R300_GPU_ROUTE_CONTRACT_RB2D_LINEAR_SOLID_FILL = 2,
   R300_GPU_ROUTE_CONTRACT_RB2D_LINEAR_SOLID_FILL_V2 = 3,
   R300_GPU_ROUTE_CONTRACT_COUNT = 4,
};

enum r300_route_admission_id {
   R300_ROUTE_ADMISSION_NONE = 0,
   R300_ROUTE_ADMISSION_R2VB_FP24_IDENTITY = 1,
   R300_ROUTE_ADMISSION_RB2D_LINEAR_SURFACE = 2,
   R300_ROUTE_ADMISSION_RB2D_WINDOWED_LINEAR_SURFACE = 3,
   R300_ROUTE_ADMISSION_COUNT = 4,
};
