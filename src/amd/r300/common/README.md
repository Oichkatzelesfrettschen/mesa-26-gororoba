...
| `r300_zb_combined_clear.c`<br>`r300_zb_combined_clear.h` | API-neutral RS485M D24S8 combined attachment clear plan: packed depth/stencil ARGB8888 fill over the exact tiled storage envelope, with guard and overflow validation. | `none` | `r300-zb-combined-clear` | `KEEP_SILICON_CONTRACT` |
