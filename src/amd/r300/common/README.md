...
| `r300_r2vb_fetched_producer.c`<br>`r300_r2vb_fetched_producer.h` | R2VB producer fetching the application vertex BO through the two-array fetched body, and its composed route over the four BO roles. | `native` | `r300-r2vb-fetched-producer` | `KEEP_SILICON_CONTRACT` |
