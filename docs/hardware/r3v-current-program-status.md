...
| RB2D fill qualification epoch | Mesa `168228122665b2af70d2c7a83db809c92f3b9d56` (route `R300_OPERATION_ROUTE_RB2D_CONST_FILL` at PRECOMMITTED), reproducible profile-4 ICD sha256 `4ad9ce18c20bd15fa01c3b411715d79fca0090dcf26d6dc2d9d90e32266987b6`, build-id `063c02b3673e3725eb8139ff9fef133b09e6286e`, loaded through `VK_DRIVER_FILES` from the build root rather than a package; kernel `7.1.8-1-cachyos`, `radeon-unified-dkms 0.8.13-1`, srcversion `46C05689F2C98A526C314F4`; stream blake3 `0f280c316371fe73...f3e1`, submission identity `0f61fdc0de662aef...33fc` for destination handle 1; prediction sealed; withdrawn from execution authorization because the kernel replay showed `r100_cs_track` tracks no legacy 2D destination (the `legacy-2d` parser class), so no attempt runs against this epoch | retained bundle `r3v-native-rb2d-const-fill-public-route-prediction-vostro1000_rs485m_5974/identity.txt` |
| RB2D fill qualification epoch v2 | the same Mesa `168228122665b2af70d2c7a83db809c92f3b9d56` ICD (sha256 `4ad9ce18c20bd15fa01c3b411715d79fca0090dcf26d6dc2d9d90e32266987b6`, build-id `063c02b3673e3725eb8139ff9fef133b09e6286e`), reused only while the 38-dword IB, one relocation site, two relocation entries, two buffer references, route code, memory contract, and arming logic stay unchanged; kernel linux-radeon-gororoba `b534d1b0a90529988f20f1bf4f29648e49d10e29` (signed tag `radeon-unified-0.8.14-profiled-source`, object `8c8404c1909225ef854f71e81c750321c912ce9a`), `radeon-unified-dkms 0.8.14-1` (the `strict-2d` parser class: the kernel bounds the 2D destination rectangle against the object the `DST_PITCH_OFFSET` relocation consumed); srcversion, boot id, and the recomputed submission identity bind at deployment; Q0, Q2, Q3, Q4, Q5, Q7, and Q8 rerun under the new epoch, Q6 reused after the ICD identity proof plus its short positive/known-bad pair; the v2 prediction supersedes the 0.8.13 one for execution alone | retained bundle `r3v-native-rb2d-const-fill-public-route-prediction-v2-vostro1000_rs485m_5974-strict-2d-cs/identity.txt` (steinmarder-r300 PR 585), deployment identity `radeon_unified_0814_target_deployment_runtime_identity_vostro1000_rs485m_5974`; srcversion `F6D858EC31CEB8A5B320781`, boot `6222574b-495d-411e-9a88-1703bad493c8`, submission identity `7e16740111ee5e66...9049e5a18` for destination handle 1; prediction sealed; the one-attempt authorization granted against it was withdrawn unspent at preflight because the sealed harness bound no attended silicon application (record `r3v-native-rb2d-const-fill-public-route-authorization-withdrawal-v2-vostro1000_rs485m_5974-strict-2d-cs`); v2 keeps its shim and arming standing and the v3 prediction supersedes it for execution |
| RB2D fill qualification epoch v3 | the same frozen ICD (sha256 `4ad9ce18c20bd15fa01c3b411715d79fca0090dcf26d6dc2d9d90e32266987b6`, build-id `063c02b3673e3725eb8139ff9fef133b09e6286e`, hashed unchanged before and after the harness build) and the same kernel epoch (`radeon-unified-dkms 0.8.14-1`, srcversion `F6D858EC31CEB8A5B320781`, boot `6222574b-495d-411e-9a88-1703bad493c8`); the harness adds the third binary role `r3v_native_attended_rb2d_fill` (profile 4 sha256 `d63f8e5246bc889bb6f39887fd7e7ec6f50fa7ef5c494b312d6339fc2d29c65b`, build-id `4a0d424fe305245a18dfec3ccdcaa40d6412b043`, source sha256 `62372a34f43f355eecf62c5a0382acaab88a621170098f54ef90c92a01185625`, qualification tooling `45bf045a2fa339cf388bcfbe65b171ac97b78a25`); role matrix, oracle mutation matrix, shim transport, host-write discriminator, real-sysfs arming, and the attended shim-refusal leg hold on both harness profiles; submission identity `7e16740111ee5e66...9049e5a18` unchanged | retained bundle `r3v-native-rb2d-const-fill-public-route-prediction-v3-vostro1000_rs485m_5974-attended-application/identity.txt` (steinmarder-r300 PR 587); prediction sealed; receipt `r3v-native-rb2d-const-fill-public-route-receipt-vostro1000_rs485m_5974-strict-2d-cs` (steinmarder-r300 PR 588): CONTROL_PASS on silicon, 4992 bytes / 1248 dwords changed exactly over [12,5004), canaries intact, submit object byte-identical to the arming emission, dmesg delta empty, boot unchanged; `R300_OPERATION_ROUTE_RB2D_CONST_FILL` PRECOMMITTED -> EXECUTING, gate retained, automatic selection BENCHMARK_PENDING, AUTO on host |
| RB2D windowed fill route composite | `R300_OPERATION_ROUTE_RB2D_CONST_FILL_V2` PRECOMMITTED -> EXECUTING, evidence SOURCE_GROUNDED/UNIT_CONTRACT -> SILICON_RETAINED/NATIVE_GPU_ROUTE_CELL, gate `R3V_NATIVE_ROUTE_RB2D_CONST_FILL_V2_EXPERIMENTAL` retained; three attended CONTROL_PASS runs under the strict-2d parser epoch (radeon-unified-dkms `0.8.14-1`, srcversion `F6D858EC31CEB8A5B320781`, kernel `7.1.8-1-cachyos`, boot `6222574b`): the two-window 256-byte carrier stream through two relocation sites (frozen ICD at mesa `617da12427ad`), the 16320-byte dense carrier at one window of five rows (same ICD), and the public route reaching 16320 through its own chooser at one window of 129 rows and 38 dwords (frozen ICD at mesa `4eb6f93c409`, sha256 `3f465307...`, build-id `3dcb3b67...`); AUTO keeps the host path and automatic selection stays withheld until the host is measured against V2 at 4 B, 64 B, 256 B, 4 KiB, 64 KiB, 512 KiB, 2 MiB, and 8 MiB | retained bundles `r3v-native-rb2d-const-fill-v2-multiwindow-receipt-vostro1000_rs485m_5974-strict-2d-cs`, `r3v-native-rb2d-dense-16320-carrier-receipt-vostro1000_rs485m_5974-strict-2d-cs`, `r3v-native-rb2d-const-fill-v2-chooser-receipt-vostro1000_rs485m_5974-strict-2d-cs` |
