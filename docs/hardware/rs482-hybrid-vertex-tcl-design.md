...
| HBTCL-04f.4 | OPEN: semantics-preserving algebraic compaction of the over-budget producer -- designed in `rs482-producer-alu-compaction-design.md` (certified-rewrite pipeline: affine-recurrence to closed form, IDCT even/odd butterfly, DP4 repack; the multiply-minimization family is gated off as a DP4-regime loss) | HBTCL-04f.2 |
